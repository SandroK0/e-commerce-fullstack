...
VALUES
  ...
  (5, 'jacket-canada-goosee', 'Size', 'S', 'Small'),
  (6, 'jacket-canada-goosee', 'Size', 'M', 'Medium'),
  (7, 'jacket-canada-goosee', 'Size', 'L', 'Large'),
  (
    8,
  ...
  (9, 'ps-5', 'Color', '#44FF03', 'Green'),
  (10, 'ps-5', 'Color', '#03FFF7', 'Cyan'),
  (11, 'ps-5', 'Color', '#030BFF', 'Blue'),
  (12, 'ps-5', 'Color', '#000000', 'Black'),
  (13, 'ps-5', 'Color', '#FFFFFF', 'White'),
  (14, 'ps-5', 'Capacity', '512G', '512G'),
  (15, 'ps-5', 'Capacity', '1T', '1T'),
  (16, 'xbox-series-s', 'Color', '#44FF03', 'Green'),
  (17, 'xbox-series-s', 'Color', '#03FFF7', 'Cyan'),
  (18, 'xbox-series-s', 'Color', '#030BFF', 'Blue'),
  (19, 'xbox-series-s', 'Color', '#000000', 'Black'),
  (20, 'xbox-series-s', 'Color', '#FFFFFF', 'White'),
...
VALUES
  (1, 'ps-5', 699),
  (2, 'apple-iphone-12-pro', 799),
  (3, 'jacket-canada-goosee', 399);
...
INSERT INTO
  `product_attributes`
VALUES
  (6, 'huarache-x-stussy-le', 'Size', 'text'),
  (7, 'jacket-canada-goosee', 'Size', 'text'),
  (8, 'ps-5', 'Color', 'swatch'),
  (9, 'ps-5', 'Capacity', 'text'),
  (10, 'xbox-series-s', 'Color', 'swatch'),
  (11, 'xbox-series-s', 'Capacity', 'text'),
  (12, 'apple-imac-2021', 'Capacity', 'text'),
  (13, 'apple-imac-2021', 'With USB 3 ports', 'text'),
  (
    14,
    'apple-imac-2021',
    'Touch ID in keyboard',
  ...
  (15, 'apple-iphone-12-pro', 'Capacity', 'text'),
  (16, 'apple-iphone-12-pro', 'Color', 'swatch');
...
-- Dump completed on 2024-11-18 22:20:33
